...
EGO_SUM=(
	...
	"github.com/jarcoal/httpmock v1.0.8/go.mod"
	...
	"github.com/rivo/tview v0.0.0-20211029142923-a4acb08f513e/go.mod"
	...
	"github.com/xanzy/go-gitlab v0.51.1/go.mod"
	...
	"github.com/yuin/goldmark v1.4.2/go.mod"
	...
	"golang.org/x/sys v0.0.0-20211103184734-ae416a5f93c7/go.mod"
...
SRC_URI="
	https://github.com/profclems/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}
"
