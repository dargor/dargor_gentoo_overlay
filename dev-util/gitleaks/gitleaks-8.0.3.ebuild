...
EGO_SUM=(
	...
	"github.com/gitleaks/go-gitdiff v0.7.2/go.mod"
...
LICENSE="MIT BSD MPL-2.0 BSD-2 Apache-2.0"
SLOT="0"
KEYWORDS="~amd64"
RESTRICT="test"

src_compile() {
	go build -mod=readonly -ldflags "-X=github.com/zricethezav/gitleaks/v8/cmd.Version=${PV}" || die
}
